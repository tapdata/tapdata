...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| <b>Full Process Automation</b><br />Table creation, switching between Full and Incremental synchronization.<br /><br/><b>Drag-And-Drop</b><br />Operate through a visual interface, allowing task construction via drag-and-drop.<br /><br /><b>Monitor</b><br/>synchronization performance, task progress, key events, and logs, clear in web page. | <img src="./assets/monitor.jpg" /> |
