...
public class DebugFindJdbc implements DebugFind {

	private final static Logger logger = LogManager.getLogger(DebugFindJdbc.class);
	...
	public DebugFindJdbc(Job job, Connections sourceConn, Connections connections, Stage stage) {
		this.job = job;
