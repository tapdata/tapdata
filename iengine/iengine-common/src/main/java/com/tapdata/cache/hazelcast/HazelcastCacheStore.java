...
public class HazelcastCacheStore extends AbstractSerializerCacheStore {
	...
	public HazelcastCacheStore(HazelcastInstance hazelcastInstance, DataFlowCacheConfig cacheConfig) {
		super(cacheConfig,
				hazelcastInstance.getMap(MemoryCacheUtil.cacheDataKey(cacheConfig.getCacheName())),
				hazelcastInstance.getMap(MemoryCacheUtil.cacheIndexKey(cacheConfig.getCacheName())));
