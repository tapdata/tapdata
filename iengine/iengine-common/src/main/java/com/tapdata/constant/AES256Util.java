...
public class AES256Util {
	...
	public static String Aes256Decode(String content, byte[] key) {
		initialize();
		String result;
		try {
			Cipher cipher = Cipher.getInstance(ALGORITHM_ECB_PKCS5);
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		String content = "root123";
		System.out.println("key: " + parseByte2HexStr(getKey()));
		System.out.println("iv: " + parseByte2HexStr(getKey()));
		System.out.println("明文： " + content);
		String encryptResult = AES256Util.Aes256Encode(content, getKey());
		System.out.println("密文： " + encryptResult);
		String decodeResult = Aes256Decode(encryptResult, getKey());
