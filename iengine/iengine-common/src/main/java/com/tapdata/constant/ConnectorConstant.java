...
public class ConnectorConstant {
	...
	public static final String JAVASCRIPT_FUNCTION_COLLECTION = "Javascript_functions/all";
	public static final String PYTHON_FUNCTION_COLLECTION = "Python_functions/all";
