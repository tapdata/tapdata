...
/**
 * If md5 is different, need synchronize.
 *
 * {
 *     "type" : "SchemaChecksum",
 *     "tables" : [
 *      {
 *          "tableId" : "test",
 *          "md5": "asdfadsfsadf" // md5 of all the fieldName and dataType
 *      }
 *     ]
 * }
 */
public class SchemaChecksumTask extends Task implements Task.TableFilter {
