 ...
 **/
public class TDDAliyunRDSPostgresMain {
...
//                "test", "-c", "/Users/aplomb/dev/tapdata/GithubProjects/idaas-pdk/tapdata-pdk-cli/src/main/resources/config/doris.json",
				"test",
				"-c",
				"plugin-kit/tapdata-pdk-cli/src/main/resources/config/aliyun-rds-postgres.json",
...
//                "-i", "connectors/mysql/mysql-core",
				...
				"connectors/aliyun-rds-postgres-connector",
		};
