...
//                e.printStackTrace();
                TapLogger.warn(TAG, "Parse time {} pattern {}, failed, {}", timeString, thePattern, e.getMessage());
            }
        } else {
            try {
...
//                throwable.printStackTrace();
                TapLogger.warn(TAG, "parse time {} pattern {}, failed {}", timeString, thePattern, throwable.getMessage());
            }
        }
        return null;
    }
