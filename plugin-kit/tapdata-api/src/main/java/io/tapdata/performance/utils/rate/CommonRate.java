package io.tapdata.performance.utils.rate;

import io.tapdata.performance.utils.IRate;

/**
 * @author <a href="mailto:harsen_lin@163.com">Harsen</a>
 * @version v1.0 2022/7/10 15:32 Create
 */
public class CommonRate implements IRate {
    private final long interval;
    private final int intervalMax;
    private int totals;
    private long lastTimes;

    public CommonRate(long interval, int intervalMax) {
