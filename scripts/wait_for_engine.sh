...
until curl -s http://tapdata-tm-official:3000/api/ > /dev/null; do
  sleep 5
  echo "Waiting for TM..."
done

echo "Registering connectors..."
java -jar lib/pdk-deploy.jar register -a 3324cfdf-7d3e-4792-bd32-571638d4562f -t http://tapdata-tm-official:3000 connectors/dist
