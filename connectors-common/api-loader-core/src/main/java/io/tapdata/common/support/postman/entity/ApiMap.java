package io.tapdata.common.support.postman.entity;

import io.tapdata.common.support.postman.entity.params.*;
    ...
    public static class ApiEntity{
        ...
        public static Api generateApiEntity(Map<String,Object> apiMap){
            try {
                ...
                io.tapdata.common.support.postman.entity.params.Request request = io.tapdata.common.support.postman.entity.params.Request.create((Map<String, Object>) apiMap.get(PostParam.REQUEST));
