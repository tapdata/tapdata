...
public class MysqlConnectionTest extends CommonDbTest {
    ...
    public MysqlConnectionTest(MysqlJdbcContext mysqlJdbcContext, Consumer<TestItem> consumer, CommonDbConfig commonDbConfig, ConnectionOptions connectionOptions) {
