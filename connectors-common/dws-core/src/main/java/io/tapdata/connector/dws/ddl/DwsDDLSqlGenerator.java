package io.tapdata.connector.dws.ddl;
 ...
 **/
public class DwsDDLSqlGenerator implements DDLSqlGenerator {
    ...
    public List<String> addColumn(CommonDbConfig config, TapNewFieldEvent tapNewFieldEvent) {
        ...
        for (TapField newField : newFields) {
            ...
            if (null != primaryKey && primaryKey) {
                TapLogger.warn(DwsDDLSqlGenerator.class.getSimpleName(), "Alter postgresql table's primary key does not supported, please do it manually");
            }
        }
        return sqls;
    }
