    ...
    private enum ConnectorEnums {
       ...
       POSTGRES(GA, TAG_JDBC),
        ...
        ConnectorEnums(AuthenticationType authType, String... tags) {
            ...
            this.path = String.format("%s/dist/%s-connector-v1.0-SNAPSHOT.jar", "/Users/gavinxiao/kit/tapdata/tapdata-connectors/connectors", connectorPrefix);
