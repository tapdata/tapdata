...
@PatchAnnotation(appType = AppType.DAAS, version = "3.5-16")
public class v3_5_16_Heartbeat_Dummy_Connection extends AbsPatch {
	private DataSourceRepository dataSourceRepository;

	public v3_5_16_Heartbeat_Dummy_Connection(PatchType type, PatchVersion version) {
		super(type, version);
