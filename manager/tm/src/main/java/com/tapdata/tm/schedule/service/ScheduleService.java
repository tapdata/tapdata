...
//        }
        ...
        if (TaskDto.STATUS_SCHEDULING.equals(status) || TaskDto.STATUS_WAIT_RUN.equals(status) || (TaskDto.STATUS_RUNNING.equals(status) && TaskDto.TYPE_INITIAL_SYNC.equals(taskDto.getType()))) {
