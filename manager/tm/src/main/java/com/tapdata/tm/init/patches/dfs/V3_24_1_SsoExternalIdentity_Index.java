 ...
 */
@PatchAnnotation(appType = AppType.DFS, version = "3.24-1")
public class V3_24_1_SsoExternalIdentity_Index extends AbsPatch {
    private static final Logger logger = LogManager.getLogger(V3_24_1_SsoExternalIdentity_Index.class);

    public V3_24_1_SsoExternalIdentity_Index(PatchType type, PatchVersion version) {
        super(type, version);
    }
