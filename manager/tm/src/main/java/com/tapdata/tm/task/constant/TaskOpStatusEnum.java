...
public enum TaskOpStatusEnum {
    ...
    to_renew_status(Lists.of(STATUS_EDIT, STATUS_WAIT_START, STATUS_STOP, STATUS_COMPLETE, STATUS_ERROR, STATUS_SCHEDULE_FAILED)),
    to_error_status(Lists.of(STATUS_RUNNING, STATUS_STOPPING)),
    to_complete_status(Lists.of(STATUS_RUNNING, STATUS_STOPPING)),
    to_delete_status(Lists.of(STATUS_EDIT, STATUS_WAIT_START, STATUS_STOP, STATUS_COMPLETE, STATUS_ERROR, STATUS_SCHEDULE_FAILED)),
    ;
