...
public class AlarmContentTemplate {
     ...
     */
    public static final String TASK_FULL_COMPLETE = "任务[$taskName]全量同步已完成，耗时{0}ms。时间：{1}";

    /**
     * - 告警格式：【级别】任务[${任务名}]增量同步已开始。时间：${增量开始时间}
     * - 告警样例：【Normal】任务[MySQL-2-Oracle]增量同步已开始。时间：2022-08-08 12:23:12
     */
    public static final String TASK_INCREMENT_START = "任务[$taskName]增量同步已开始。时间：{0}";
     ...
     */
    public static final String SYSTEM_FLOW_EGINGE_DOWN_NO_AGENT = "任务[$taskName]所在Agent[{0}]已停止运行，当前已无可用Agent，将会影响任务正常运行，请尽快处理！时间：{1}";
