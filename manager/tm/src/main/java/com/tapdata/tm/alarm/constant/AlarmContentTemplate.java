...
public class AlarmContentTemplate {
    /**
     * 【级别】任务[${任务名}]运行出现错误，请及时处理！时间：${告警发生时间}
     */
    public static final String TASK_STATUS_ERROR = "任务[{0}]运行出现错误，请及时处理！时间：{1}";

    /**
     * 【级别】任务[${任务名}]的数据检验任务出错，请关注！时间：${告警发生时间}
     */
    public static final String TASK_INSPECT_ERROR = "任务[{0}]的数据检验任务出错，请关注！时间：{1}";

    /**
     * 【级别】任务[${任务名}]全量同步已完成，耗时${全量耗时}。时间：${全量完成时间}
     */
    public static final String TASK_FULL_COMPLETE = "任务[{0}]全量同步已完成，耗时{1}。时间：{2}";

    /**
     * 【级别】任务[${任务名}]增量同步已开始。时间：${增量开始时间}
     */
    public static final String TASK_INCREMENT_COMPLETE = "任务[{0}]增量同步已开始。时间：{1}";

    /**
     * 【级别】任务[${任务名}]已出错停止，请尽快处理！时间：${出错停止时间}
     */
    public static final String TASK_STATUS_STOP_ERROR = "任务[{0}]已出错停止，请尽快处理！时间：{1}";

    /**
     * 【级别】任务[${任务名}]已被用户[${停止任务的用户名}]停止，请关注！时间：${停止时间}
     */
    public static final String TASK_STATUS_STOP_MANUAL = "任务[{0}]已被用户[{1}]停止，请关注！时间：{0}";
