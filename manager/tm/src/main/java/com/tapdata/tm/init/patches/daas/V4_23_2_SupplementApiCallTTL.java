 ...
 * @description
 */
@PatchAnnotation(appType = AppType.DAAS, version = "4.23-2")
public class V4_23_2_SupplementApiCallTTL extends V4_14_21_AddApiCallTTL {
    private static final Logger logger = LogManager.getLogger(V4_23_2_SupplementApiCallTTL.class);

    public V4_23_2_SupplementApiCallTTL(PatchType patchType, PatchVersion version) {
