...
public class SmsService {
    ...
    public SendStatus sendShortMessage(String templateCode, String phoneNumbers, String system, String jobName) {
        ...
        try {
            ...
            //替换成你的AK
            final String accessKeyId = "LTAI5tRs7Bi4t4ngvH94uX17";//你的accessKeyId,参考本文档步骤2
            final String accessKeySecret = "BD2jMva28sSjMoXiJNDMpetiTVkbQS";//你的accessKeySecret，参考本文档步骤2
