...
public interface DiscoveryService {
    ...
    void updateListTags(String id, String objCategory, List<String> tagIds, UserDetail user);

    void addListTags(String id, String objCategory, List<String> tagIds, UserDetail user);
}
