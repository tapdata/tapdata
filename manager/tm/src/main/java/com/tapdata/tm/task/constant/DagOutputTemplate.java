...
public class DagOutputTemplate {
     ...
     */
    public static String TABLE_EDIT_NODE_INFO = " {0} 【{1}】\n【表编辑节点设置检测】：节点{2}检测通过";
    public static String TABLE_EDIT_NODE_ERROR = " {0} 【{1}】\n【表编辑节点设置检测】：节点{2}检测未通过，异常项属性：{前缀}，异常原因：设置有误，请重新设置";
     ...
     */
    public static String SOURCE_CONNECT_INFO = " {0} 【{1}】\n【源连接检测】：连接XXX检测通过";
    public static String SOURCE_CONNECT_ERROR = " {0} 【{1}】\n【源连接检测】：连接XXX";

    /**
     * 目标连接检测
     */
    public static String TARGET_CONNECT_INFO = " {0} 【{1}】\n【目标连接检测】：源连接状态检查XXX";
    public static String TARGET_CONNECT_ERROR = " {0} 【{1}】\n【目标连接检测】：源连接状态检查XXX";
     ...
     */
    public static String CHARACTER_ENCODING_INFO = " {0} 【{1}】\n【字符编码检测】：源库和目标库字符编码一致，均为UTF-8，检测正常";
    public static String CHARACTER_ENCODING_WARN = " {0} 【{1}】\n【字符编码检测】：检测异常，异常项{编码不一致}，异常原因：目标库为GBK，源和目标编码不一致，可能会出现乱码";
     ...
     */
    public static String TABLE_NAME_CASE_INFO = " {0} 【{1}】\n【表名大小写检测】： 源库表名和目标库表名大小写设置一致，检测正常";
    public static String TABLE_NAME_CASE_ERROR = " {0} 【{1}】\n【表名大小写检测】：检测异常，异常原因：源库表名为大写，目标库表名默认为小写，可能会影响到任务同步";
     ...
     */
    public static String DATA_INSPECT_INFO = " {0} 【{1}】\n【节点名称】【数据校验检测】：支持数据校验，其中支持校验表数量为20张，不支持校验表数量为0张";
    public static String DATA_INSPECT_ERROR = " {0} 【{1}】\n【数据校验检测】：该连接不支持数据校验";
}
