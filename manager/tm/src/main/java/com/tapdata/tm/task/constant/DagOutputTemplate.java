...
public class DagOutputTemplate {
     ...
     */
    public static String AGENT_CAN_USE_INFO = "【INFO】{0} 【{1}】【Agent可用性检测】：检查到当前有{2}个可用Agent，当前任务将在Agent：{{3}}上运行";
    public static String AGENT_CAN_USE_ERROR = "【ERROR】{0}【{1}】【Agent可用性检测】：当前无可用Agent，任务运行失败";
     ...
     */
    public static String TASK_SETTING_INFO = "【INFO】{0} 【{1}】【任务设置检测】：任务{{1}}检测通过";
    public static String TASK_SETTING_ERROR = "【ERROR】 {0} 【{1}】【任务设置检测】：任务{{1}}检测未通过，异常项{任务名称}，异常原因：任务名称重复，请重新设置";
     ...
     */
    public static String SOURCE_SETTING_INFO = "【INFO】 {0} 【{1}】【源节点设置检测】：节点{{2}}检测通过";
    public static String SOURCE_SETTING_ERROR = "【ERROR】 {0} 【{1}】【源节点设置检测】：节点{{2}}检测未通过，异常项{节点名称}，异常原因：节点名称重复，请重新设置";
     ...
     */
    public static String JS_NODE_INFO = "【INFO】 {0} 【{1}】 【JS节点设置检测】：节点{{2}}检测通过";
    public static String JS_NODE_ERROR = "【ERROR】 {0} 【{1}】 【JS节点设置检测】：节点{{2}}检测未通过，异常项属性：{脚本}，异常原因：设置有误，请重新设置";
     ...
     */
    public static String TABLE_EDIT_NODE_INFO = "【INFO】 {0} 【{1}】【表编辑节点设置检测】：节点{2}检测通过";
    public static String TABLE_EDIT_NODE_ERROR = "【ERROR】 {0} 【{1}】 【表编辑节点设置检测】：节点{2}检测未通过，异常项属性：{前缀}，异常原因：设置有误，请重新设置";
     ...
     */
    public static String FIELD_EDIT_NODE_INFO = "【INFO】 {0} 【{1}】【字段编辑节点设置检测】：节点{{2}}检测";
    public static String FIELD_EDIT_NODE_ERROR = "【ERROR】 {0} 【{1}】【字段编辑节点设置检测】：节点{{2}}检测未通过，异常项属性：{后缀}，异常原因：设置有误，请重新设置";
     ...
     */
    public static String TARGET_NODE_INFO = "【INFO】 {0} 【{1}】 【目标节点设置检测】：节点{{2}}检测通过";
    public static String TARGET_NODE_ERROR = "【ERROR】 {0} 【{1}】【目标节点设置检测】：节点{{2}}检测未通过，异常项属性：{节点名称}，异常原因：节点名称重复，请重新设置";
     ...
     */
    public static String SOURCE_CONNECT_INFO = "【INFO】 {0} 【{1}】【源连接检测】：连接XXX检测通过";
    public static String SOURCE_CONNECT_ERROR = "【ERROR】 {0} 【{1}】【源连接检测】：连接XXX";

    /**
     * 目标连接检测
     */
    public static String TARGET_CONNECT_INFO = "【INFO】 {0} 【{1}】【目标连接检测】：源连接状态检查XXX";
    public static String TARGET_CONNECT_ERROR = "【INFO】 {0} 【{1}】【目标连接检测】：源连接状态检查XXX";
     ...
     */
    public static String CHARACTER_ENCODING_INFO = "【INFO】 {0} 【{1}】【字符编码检测】：源库和目标库字符编码一致，均为UTF-8，检测正常";
    public static String CHARACTER_ENCODING_WARN = "【WARN】 {0} 【{1}】【字符编码检测】：检测异常，异常项{编码不一致}，异常原因：目标库为GBK，源和目标编码不一致，可能会出现乱码";
     ...
     */
    public static String TABLE_NAME_CASE_INFO = "【INFO】 {0} 【{1}】【表名大小写检测】： 源库表名和目标库表名大小写设置一致，检测正常";
    public static String TABLE_NAME_CASE_ERROR = "【WARN】 {0} 【{1}】【表名大小写检测】：检测异常，异常原因：源库表名为大写，目标库表名默认为小写，可能会影响到任务同步";
     ...
     */
    public static String MODEL_PROCESS_INFO = "";
    public static String MODEL_PROCESS_ERROR = "";
     ...
     */
    public static String DATA_INSPECT_INFO = "【INFO】 {0} 【{1}】【节点名称】【数据校验检测】：支持数据校验，其中支持校验表数量为20张，不支持校验表数量为0张";
    public static String DATA_INSPECT_ERROR = "【WARN】 {0} 【{1}】【数据校验检测】：该连接不支持数据校验";
}
