...
class V4_910_AddApiCallTTLTest {
    ...
    private V4_9_10_AddApiCallTTL patch;

    @BeforeEach
    void setUp() {
        patch = new V4_9_10_AddApiCallTTL(null, null);
    }

    @Test
    void testConstructor() {
        V4_9_10_AddApiCallTTL newPatch = new V4_9_10_AddApiCallTTL(null, null);
