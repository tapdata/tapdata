...
class QueryTest {
    ...
    void setUp() {
        ...
        queryTool = new com.tapdata.tm.mcp.tools.mongo.Query(new MongoOperatorFactory(toolSupport, dataSourceService));
    }
    ...
    void testCallWithValidParameters() {
        ...
        try (MockedStatic<Utils> ms = mockStatic(Utils.class)) {
            ...
            try (var mc = mockConstruction(MongoOperator.class, (mock, context) -> {
                ...
                // 执行测试
                List<Document> result = queryTool.query(context, connectionId, collectionName,
                        new Document("name", "John"), null, null, null, null, null);
    ...
    void testCallWithoutCollectionName() {
        ...
        try (MockedStatic<Utils> ms = mockStatic(Utils.class)) {
            ...
            assertThrows(RuntimeException.class,
                    () -> queryTool.query(context, connectionId, null, null, null, null, null, null, null));
        }
    }
    ...
    void testCallWithQueryError() {
        ...
        try (MockedStatic<Utils> ms = mockStatic(Utils.class)) {
            ...
            try (var mc = mockConstruction(MongoOperator.class, (mock, context) -> {
                ...
                // 执行测试
                assertThrows(RuntimeException.class,
                        () -> queryTool.query(context, connectionId, collectionName, null, null, null, null, null, null));
