...
public abstract class DataSourceService extends BaseService<DataSourceConnectionDto, DataSourceEntity, ObjectId, DataSourceRepository> {
    ...
    public abstract long refreshModel(Where where, Document update, DataSourceConnectionDto connectionDto, UserDetail user);

    public abstract long updatePartialSchema(String id, String loadFieldsStatus, Long lastUpdate, String fromSchemaVersion, String toSchemaVersion, String filters, UserDetail user);
