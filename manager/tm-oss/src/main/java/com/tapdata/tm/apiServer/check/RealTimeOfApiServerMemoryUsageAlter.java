 ...
 * @version v1.0 2025/9/16 11:43 Create
 * @description
 */
@Service
public class RealTimeOfApiServerMemoryUsageAlter implements CheckCPUMemoryBase {
    @Override
    ...
    public AlarmKeyEnum type() {
        return AlarmKeyEnum.API_SERVER_MEMORY_USAGE_ALTER;
    }
}
