 ...
 * @version v1.0 2025/9/16 09:10 Create
 * @description
 */
@Service
public class RealTimeOfApiServerCpuUsageAlter implements CheckCPUMemoryBase {
    ...
    public AlarmKeyEnum type() {
        return AlarmKeyEnum.API_SERVER_CPU_USAGE_ALTER;
    }
}
