...
class ExecCommand implements CdcStep<CdcRoot> {
    ...
    public CdcRoot compile() {
        ...
        String cmd = START_CDC
                .replaceAll("\\$taskId\\$", root.getCdcId())
