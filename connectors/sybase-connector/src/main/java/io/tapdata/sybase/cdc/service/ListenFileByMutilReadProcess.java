...
public class ListenFileByMutilReadProcess implements CdcStep<CdcRoot> {
    ...
    protected ListenFileByMutilReadProcess(CdcRoot root,
                                           String monitorPath,
    ...
    public ListenFileByMutilReadProcess monitor(FileMonitor monitor) {
