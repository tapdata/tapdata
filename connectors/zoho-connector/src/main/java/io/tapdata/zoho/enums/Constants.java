...
public class Constants {
    ...
    public static final String LINE_DELIMITER_DEFAULT_2 = "\r\n";
    public static final String ESCAPE_CHARACTER_DOUBLE_QUOTATION = "\"";
    ...
    public static final String CUSTOM_FIELD_SUFFIX = "CustomField_";
}