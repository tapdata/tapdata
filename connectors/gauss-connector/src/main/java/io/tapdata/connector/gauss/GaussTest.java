...
public class GaussTest extends CommonDbTest {
    ...
    public GaussTest initContext() {
        jdbcContext = new GaussJdbcContext(commonDbConfig);
        return this;
    }
    ...
    public Boolean testStreamRead() {
        ...
        try {
            ...
            testSqls.add(String.format(PG_LOG_PLUGIN_CREATE_TEST, testSlotName, ((GaussConfig) commonDbConfig).getLogPluginName()));
