...
public class AdminConfiguration extends AbstractConfiguration {
    ...
    public Map<String, Object> build() {
        configMap.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, this.kafkaConfig.getKafkaBootstrapServers());
        configMap.put(AdminClientConfig.CLIENT_ID_CONFIG, String.format("TapData-KafkaAdmin-%s-%s", connectorId, UUID.randomUUID().toString()));
