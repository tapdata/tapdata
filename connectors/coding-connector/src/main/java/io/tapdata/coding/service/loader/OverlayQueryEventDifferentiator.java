...
public interface OverlayQueryEventDifferentiator {
    ...
    public default String createOrUpdateEvent(Integer code, Integer hash){
    ...
    public default List<TapEvent> delEvent(String tableName,String primaryKeyName){
