...
public enum  CodingEvent {
    ITERATION_DELETED("ITERATION_DELETED",IssueEventTypes.DELETED_EVENT,"Iterations"),
    ...
    MEMBER_CREATED("MEMBER_CREATED",IssueEventTypes.CREATED_EVENT,"ProjectMembers"),
    ...
    ISSUE_UPDATED("ISSUE_UPDATED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ...
    ISSUE_RELATIONSHIP_CHANGED("ISSUE_RELATIONSHIP_CHANGED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ...
    ISSUE_ASSIGNEE_CHANGED("ISSUE_ASSIGNEE_CHANGED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ...
    ITERATION_UPDATED("ITERATION_UPDATED",IssueEventTypes.UPDATE_EVENT,"Iterations"),
    GIT_MR_NOTE("GIT_MR_NOTE",IssueEventTypes.UPDATE_EVENT,""),
    ISSUE_HOUR_RECORD_UPDATED("ISSUE_HOUR_RECORD_UPDATED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ...
    ITERATION_CREATED ("ITERATION_CREATED",IssueEventTypes.CREATED_EVENT,"Iterations"),
    ...
    MEMBER_ROLE_UPDATED("MEMBER_ROLE_UPDATED",IssueEventTypes.UPDATE_EVENT,"ProjectMembers"),
    FILE_RESTORED_FROM_RECYCLE_BIN("FILE_RESTORED_FROM_RECYCLE_BIN",IssueEventTypes.UPDATE_EVENT,""),
    ISSUE_DELETED("ISSUE_DELETED",IssueEventTypes.DELETED_EVENT,"Issues"),
    FILE_RENAMED("FILE_RENAMED",IssueEventTypes.UPDATE_EVENT,""),
    ITERATION_PLANNED("ITERATION_PLANNED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ISSUE_ITERATION_CHANGED("ISSUE_ITERATION_CHANGED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ...
    MEMBER_DELETED("MEMBER_DELETED",IssueEventTypes.DELETED_EVENT,"ProjectMembers"),
    ISSUE_STATUS_UPDATED("ISSUE_STATUS_UPDATED",IssueEventTypes.UPDATE_EVENT,"Issues"),
    ISSUE_CREATED("ISSUE_CREATED",IssueEventTypes.CREATED_EVENT,"Issues"),
    GIT_MR_MERGED("GIT_MR_MERGED",IssueEventTypes.UPDATE_EVENT,""),
    ISSUE_COMMENT_CREATED("ISSUE_COMMENT_CREATED",IssueEventTypes.CREATED_EVENT,"Issues"),
