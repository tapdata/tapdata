...
public class OpenGaussTest extends CommonDbTest {

    public OpenGaussTest() {
        super();
    }

    public OpenGaussTest(OpenGaussConfig openGaussConfig, Consumer<TestItem> consumer) {
        super(openGaussConfig, consumer);
    }

    public OpenGaussTest initContext() {
        jdbcContext = DataSourcePool.getJdbcContext(commonDbConfig, OpenGaussJdbcContext.class, uuid);
        return this;
    }
    ...
    public Boolean testStreamRead() {
        ...
        try {
            ...
            testSqls.add(String.format(PG_LOG_PLUGIN_CREATE_TEST, testSlotName, ((OpenGaussConfig) commonDbConfig).getLogPluginName()));
