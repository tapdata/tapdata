...
public class OpenGaussJdbcContext extends JdbcContext {

    private final static String TAG = OpenGaussJdbcContext.class.getSimpleName();

    public OpenGaussJdbcContext(OpenGaussConfig config, HikariDataSource hikariDataSource) {
