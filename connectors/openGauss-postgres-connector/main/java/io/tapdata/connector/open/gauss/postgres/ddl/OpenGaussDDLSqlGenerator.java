package io.tapdata.connector.open.gauss.postgres.ddl;
    ...
    public List<String> addColumn(CommonDbConfig config, TapNewFieldEvent tapNewFieldEvent) {
        ...
        for (TapField newField : newFields) {
            ...
            if (null != primaryKey && primaryKey) {
                TapLogger.warn(OpenGaussDDLSqlGenerator.class.getSimpleName(), "Alter postgresql table's primary key does not supported, please do it manually");
            }
        }
        return sqls;
    }
