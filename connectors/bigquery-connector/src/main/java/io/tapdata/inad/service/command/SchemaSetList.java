package io.tapdata.inad.service.command;

import io.tapdata.inad.entity.ContextConfig;
import io.tapdata.inad.service.bigQuery.BigQueryResult;
import io.tapdata.inad.service.bigQuery.BigQueryStart;
import io.tapdata.inad.service.bigQuery.SqlMarker;
...
public class SchemaSetList implements Command {
    ...
    public CommandResult commandResult(TapConnectionContext tapConnectionContext, CommandInfo commandInfo) {
        ...
        BigQueryResult bigQueryResult = sqlMarker.executeOnce(SQL.replace("#{projectId}",projectId));
