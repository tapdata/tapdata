package io.tapdata.inad.util.http;
...
import io.tapdata.inad.util.tool.Checker;
...
public class Http {
    ...
    private Http(){}
    public static Http create(HttpType httpType){
        return new Http().httpType(httpType);
    }
    public static Http create(String url,HttpType httpType){
        return new Http().url(url).httpType(httpType);
    }
    public static Http create(String url,HttpType httpType,HttpEntity<String,String> heard){
        return new Http().url(url).httpType(httpType).header(heard);
    }
    public static Http create(String url,HttpType httpType,HttpEntity<String,String> heard,HttpEntity<String,Object> body){
        return new Http().url(url).httpType(httpType).header(heard).body(body);
    }
    public Http body(String refreshToken){
        this.refreshToken = refreshToken;
        return this;
    }
    public Http body(HttpEntity<String,Object> body){
        this.body = body;
        return this;
    }
    public Http header(HttpEntity<String,String> header){
        this.heard = header;
        return this;
    }
    ...
    public Http httpType(HttpType httpType){
        this.httpType = httpType;
        return this;
    }
    public Http httpType(String httpType){
        this.httpType = HttpType.set(httpType);
        return this;
    }
    public Http resetFull(HttpEntity<String,String> resetFull){
        this.resetFull = resetFull;
        return this;
    }
    public Http form(HttpEntity<String,Object> form){
        this.form = form;
        return this;
    }
