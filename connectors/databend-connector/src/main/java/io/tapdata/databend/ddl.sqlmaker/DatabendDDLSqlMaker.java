package io.tapdata.databend.ddl.sqlmaker;
...
public class DatabendDDLSqlMaker implements DDLSqlMaker {
    ...
    public List<String> addColumn(TapConnectorContext tapConnectorContext, TapNewFieldEvent tapNewFieldEvent) {
        ...
        if (StringUtils.isBlank(tableId)) {
            throw new RuntimeException("Databend Append add column ddl sql failed, table name is blank");
        }
        for (TapField newField : newFields) {
            ...
            if (StringUtils.isNotBlank(fieldName)) {
                ...
                throw new RuntimeException("Databend Append add column ddl sql failed, field name is blank");
            }
            ...
            if (StringUtils.isNotBlank(dataType)) {
                ...
                throw new RuntimeException("Databend Append add column ddl sql failed, data type is blank");
            }
    ...
    public List<String> alterColumnAttr(TapConnectorContext tapConnectorContext, TapAlterFieldAttributesEvent tapAlterFieldAttributesEvent) {
        ...
        if (StringUtils.isBlank(tableId)) {
            throw new RuntimeException("Databend Append alter column attr ddl sql failed, table name is blank");
        }
        ...
        if (StringUtils.isNotBlank(fieldName)) {
            ...
            throw new RuntimeException("Databend Append alter column attr ddl sql failed, field name is blank");
        }
        ...
        if (StringUtils.isNotBlank(dataTypeChange.getAfter())) {
            ...
            throw new RuntimeException("Databend Append alter column attr ddl sql failed, data type is blank");
        }
    ...
    public List<String> alterColumnName(TapConnectorContext tapConnectorContext, TapAlterFieldNameEvent tapAlterFieldNameEvent) {
        ...
        if (StringUtils.isBlank(tableId)) {
            throw new RuntimeException("Databend Append alter column name ddl sql failed, table name is blank");
        }
        ValueChange<String> nameChange = tapAlterFieldNameEvent.getNameChange();
        if (null == nameChange) {
            throw new RuntimeException("Databend Append alter column name ddl sql failed, change name object is null");
        }
        String before = nameChange.getBefore();
        String after = nameChange.getAfter();
        if (StringUtils.isBlank(before)) {
            throw new RuntimeException("Databend Append alter column name ddl sql failed, old column name is blank");
        }
        if (StringUtils.isBlank(after)) {
            throw new RuntimeException("Databend Append alter column name ddl sql failed, new column name is blank");
        }
    ...
    public List<String> dropColumn(TapConnectorContext tapConnectorContext, TapDropFieldEvent tapDropFieldEvent) {
        ...
        if (StringUtils.isBlank(tableId)) {
            throw new RuntimeException("Databend Append drop column ddl sql failed, table name is blank");
        }
        String fieldName = tapDropFieldEvent.getFieldName();
        if (StringUtils.isBlank(fieldName)) {
            throw new RuntimeException("Databend Append drop column ddl sql failed, field name is blank");
        }
