...
import io.tapdata.databend.util.LRURemoveMap;
...
public class TapTableWriter implements IWriter<TapRecordEvent, WriteListResult<TapRecordEvent>> {
    ...
    protected final Map<String, PreparedStatement> statementMap = new LRURemoveMap<>(10, s -> JdbcUtil.closeQuietly(s.getValue()));
