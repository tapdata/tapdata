...
public class ConnectionTest {
    ...
    public TestItem testTableName(){
        try {
            ...
            return testItem(TestHttpItem.TEST_TABLE_NAME.content(), matches ? TestItem.RESULT_SUCCESSFULLY_WITH_WARN : TestItem.RESULT_SUCCESSFULLY, "There are some special characters in the table name. Please confirm if necessary, and ignore this prompt if necessary.");
        }catch (Exception e){
