 ...
 **/
@TapConnectorClass("huaweiCloudRdsMysql-spec.json")
public class HuaweiCloudRdsMysqlConnector extends ConnectorBase {
    private static final String TAG = HuaweiCloudRdsMysqlConnector.class.getSimpleName();
