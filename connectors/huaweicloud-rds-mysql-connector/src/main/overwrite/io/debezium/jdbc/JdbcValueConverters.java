...
public class JdbcValueConverters implements ValueConverterProvider {
	 ...
	 * {@link java.util.Date}, {@link LocalTime}, and {@link java.time.LocalDateTime}.
	 *
	 ...
	 * {@link LocalTime}, and {@link java.time.LocalDateTime}. If any of the types have date components, those date
	 ...
	 * as {@link java.util.Date}, {@link LocalTime}, and {@link java.time.LocalDateTime}.
	 *
	 * @param column the column definition describing the {@code data} value; never null
	 * @param fieldDefn the field definition; never null
	 * @param data the data object to be converted into a {@link Date Kafka Connect date} type; never null
	 ...
	 * {@link java.util.Date}, {@link LocalTime}, and {@link java.time.LocalDateTime}. If any of the types might
	 ...
	 * time zones. This method handles {@link java.sql.Date} objects plus any other standard date-related objects such as
	 * {@link java.util.Date}, {@link LocalDate}, and {@link java.time.LocalDateTime}. If any of the types might
