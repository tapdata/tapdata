...
public abstract class MariadbWriter {

	private static final String TAG = MariadbWriter.class.getSimpleName();
	...
	protected MariadbContext mariadbContext;
	protected Connection connection;

	public MariadbWriter(MariadbContext mariadbContext) throws Throwable {
		this.mariadbContext = mariadbContext;
		this.connection = mariadbContext.getConnection();
	}
